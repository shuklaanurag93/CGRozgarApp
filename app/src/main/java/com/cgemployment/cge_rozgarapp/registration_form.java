...
public class registration_form extends AppCompatActivity implements SurfaceHolder.Callback, CameraSource.PictureCallback {
    ...
    RadioButton disability_NO, disability_Yes, rural, urban;
    LinearLayout reg_form_llA, reg_form_llB;
    ...
    TextInputEditText username_tv, mobile_tv;
    ...
    TextInputEditText fathersname_tv;
    ...
    RadioButton gender_M, gender_F, gender_T, married, unmarried, caste_Gen, caste_OBC, caste_SC, caste_ST;
    String Gender = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //////////////////////////////////////////////////////////////////////
        dialog = new Dialog(registration_form.this);
      ...
      // AllCertificatesAndHostsTruster.apply();
        ...
        btn_aadhar_otp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View view1 = LayoutInflater.from(registration_form.this).inflate(
        ...
        DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int day) {
                ...
                DOB_picker_actions.setText(dateFormat.format(myCalendar.getTime()));
            }
        };
        DOB_picker_actions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(registration_form.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH));
        ...
        switch (view.getId()) {
            ...
            case R.id.Aadhardeclaration_checkbox:
                if (checked) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(registration_form.this);
                    View layout_dialog = LayoutInflater.from(registration_form.this).inflate(R.layout.aadhar_dailog, null);
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        String ImagePath = RealPathUtil.getRealPath(registration_form.this, picUri);
                    ...
                    public void onResponse(JSONObject response) {
                     ...
                     /*   ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                        ...
                        Highest_Qualification_sp.setAdapter(arrayAdapter);
                            ...
                            Highest_Qualification_sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, HighestQualificatioNameArray, defaultTextForSpinner));
                            dialog.dismiss();
                    ...
                    public void onResponse(JSONObject response) {
                     ...
                     /*   ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                        ...
                        Highest_Qualification_sp.setAdapter(arrayAdapter);
                            ...
                            pvtgsp_sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, SubcataNameArray, defaultTextForSpinner));
                            dialog.dismiss();
                        ...
                        try {
                         ...
                         /*   ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                            ...
                            dialog.dismiss(); */
                                ...
                                Subject_sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, SubjectNameArray, defaultTextForSpinner));
                                dialog.dismiss();
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    /*        ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                         ...
                         Dist_Sp.setAdapter(arrayAdapter);
                            ...
                            Dist_Sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, DistrictMasterArray, defaultTextForSpinner));
                            dialog.dismiss();
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                      ...
                      /*     ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                            ...
                            block_Sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, BlockMasterArray, defaultTextForSpinner));
                            dialog.dismiss();
...
/////////////////////////Nagriynikay/////////////////////
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                     ...
                     /*      ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                            ...
                            nagrinikay_Sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, nagarMasterArray, defaultTextForSpinner));
                            dialog.dismiss();
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                     ...
                     /*     ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                            ...
                            ward_ll_sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, WardMasterArray, defaultTextForSpinner));
                            dialog.dismiss();
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                     ...
                     /*    ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                            ...
                            panchayt_Sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, GramPanchaytArray, defaultTextForSpinner));
                            dialog.dismiss();
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                     ...
                     /*  ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                            ...
                            gram_Sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, GramArray, defaultTextForSpinner));
                            dialog.dismiss();
                    ...
                    public void onResponse(JSONObject response) {
                     ...
                     /*   ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                        ...
                        Highest_Qualification_sp.setAdapter(arrayAdapter);
                            ...
                            StatusOf_job_Sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, StatusOf_jobNameArray, defaultTextForSpinner));
                            dialog.dismiss();
                    ...
                    public void onResponse(JSONObject response) {
                     ...
                     /*   ArrayAdapter arrayAdapter = new ArrayAdapter(registration_form.this,
                        ...
                        Highest_Qualification_sp.setAdapter(arrayAdapter);
                            ...
                            disability_sp.setAdapter(new CustomSpinnerAdapter(registration_form.this, R.layout.spinner_row, disabilityNameArray, defaultTextForSpinner));
                            dialog.dismiss();
                        ...
                        try {
                            ...
                            if (result.equals("204")) {
                                ...
                                AlertDialog.Builder builder =
                                        new AlertDialog.Builder
                                                (registration_form.this);
                                View view = LayoutInflater.from(registration_form.this).inflate(
    ...
    public void NewCandidateRegistration(String image,String accesstoken ) {
        dialog.show();
        RequestQueue queue = Volley.newRequestQueue(this);
        JSONObject jsonObject = new JSONObject();
        ...
        JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.POST, Constants_URL.NewCandidateRegistration, jsonObject,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String result = null;
    ...
    private void requestPermissions(String[] permissions) {
        ActivityCompat.requestPermissions(registration_form.this, permissions, CAMERA_REQUEST);
    }
        ...
        if (requestCode == CAMERA_REQUEST) {
            for (int result : grantResults) {
                if (result == PackageManager.PERMISSION_DENIED) {
                    Toast.makeText(registration_form.this, R.string.permission_warning, Toast.LENGTH_LONG).show();
    ...
    private void startCamera() {
        try {
            ...
            detector.setProcessor(new LargestFaceFocusingProcessor(detector,
                    new GraphicFaceTracker(registration_form.this)));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (result.equals("200")) {
                            ...
                            String _token = MSG;
                            NewCandidateRegistration(encodedimage,_token);
