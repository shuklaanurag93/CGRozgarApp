...
public class GraphicFaceTracker2 extends Tracker<Face> {

    private static final float OPEN_THRESHOLD = 0.85f;
    private static final float CLOSE_THRESHOLD = 0.4f;
    private final job_renewal_form Job_renewal_form;
    private int state = 0;
    int blinkcount = 0;

    GraphicFaceTracker2(job_renewal_form Job_renewal_form) {
        this.Job_renewal_form = Job_renewal_form;
    }
    ...
    private void blink(float value) {
        switch (state) {
            ...
            case 2:
                ...
                if (blinkcount == 4) {
                    Job_renewal_form.captureImage();
                    blinkcount = 0;

                } else {
                    Job_renewal_form.blinkCountfn(blinkcount);
